...
@pytest.mark.parametrize(*c_exec)
def test_RestrictingNodeTransformer__visit_Call__2(c_exec):
...
@pytest.mark.parametrize(*c_exec)
def test_RestrictingNodeTransformer__visit_Call__3(c_exec):
...
@pytest.mark.skipif(
    ...
    reason="tuple parameter unpacking is gone in python 3")
@pytest.mark.parametrize(*e_exec)
def test_RestrictingNodeTransformer__visit_FunctionDef_2(
        e_exec, mocker):
    _getiter_ = mocker.stub()
...
@pytest.mark.skipif(
    ...
    reason="tuple parameter unpacking is gone in python 3")
@pytest.mark.parametrize(*e_exec)
def test_RestrictingNodeTransformer__visit_Lambda_2(
        e_exec, mocker):
    _getiter_ = mocker.stub()
    _getiter_.side_effect = lambda it: it
    glb = {
