...
functiondef_err_msg = 'Line 1: "_bad" is an invalid variable name because it starts with "_"'  # NOQA: E501
...
@pytest.mark.skipif(
    IS_PY3, reason="tuple parameter unpacking is gone in Python 3"
)
@pytest.mark.parametrize(*c_exec)
...
@pytest.mark.skipif(
    IS_PY2, reason="There is no single `*` argument in Python 2"
)
@pytest.mark.parametrize(*c_exec)
