...
@pytest.mark.skipif(
    IS_PY2, reason="exec statement in Python 2 is handled by RestrictedPython "
)
@pytest.mark.parametrize(*c_exec)
...
@pytest.mark.skipif(
    IS_PY3,
    reason="Print statement is gone in Python 3. Test Deprecation Warning in Python 2",  # NOQA: E501
)
